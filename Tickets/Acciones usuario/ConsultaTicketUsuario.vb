Public Class frmConsultaTicketUsuario

    Dim codt As Integer
    Dim asunto As String
    Dim consulta As String

    Private Sub frmConsultaTicketUsuario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        sql = "select codticket from ticket where asunto = '" & txtAsunto.Text & "' and consulta = '" & txtConsulta.Text & "' and codusuario = " & codu & ""
        Call ejecutar(sql)
        rs.Read()
        codt = rs(0)
